...
def ledcontrol(led,ctrlarr):
    for i in led:
        GPIO.setup(i,GPIO.OUT)

    for i,ch in enumerate(led):
        GPIO.output(ch,int(ctrlarr[i]))
...
while(True):
    ...
    img = r'img_1.jpg'  # or file, Path, PIL, OpenCV, numpy, list
